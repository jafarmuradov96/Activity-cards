...
//   return (
//     <section className="mt-[194px] bg-gray-50 mb-12">
...
//           <div className=" w-[64px] h-[64px] bg-bgStep rounded-full flex items-center justify-center text-[32px] font-[700]">
//             1
//           </div>
...
//         <div className="flex items-start justify-between w-full">
//           <div className="w-[40%]">
//             <h6 className="text-[32px] font-[700]">Təstiq et</h6>
//             <p className="text-[20px]">
...
//         <div className="flex items-start justify-between w-full">
//           <div className="w-[40%]">
//             <h6 className="text-[32px] font-[700]">Yadda saxla</h6>
//             <p className="text-[20px]">
